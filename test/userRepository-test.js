...
describe('User Repository', () => {
  ...
  it('should return the average values for all users', () => {
    ...
    const average1 = userRepository.returnAverageActivityData('numSteps', '', '2019/06/15', activityData)
    expect(average1).to.equal('3936')

    const average2 = userRepository.returnAverageActivityData('minutesActive', '', '2019/06/15', activityData)
    expect(average2).to.equal('139')

    const average3 = userRepository.returnAverageActivityData('flightsOfStairs', '', '2019/06/15', activityData)
